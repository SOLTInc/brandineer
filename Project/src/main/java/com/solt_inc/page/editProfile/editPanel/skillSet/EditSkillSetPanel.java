package com.solt_inc.page.editProfile.editPanel.skillSet;
...
public class EditSkillSetPanel extends Panel {
	...
	public EditSkillSetPanel(String id, IModel<List<SkillSetDto>> skillSetListModel1, IModel<Integer> userIdModel) {

		super(id, skillSetListModel1);
		this.skillSetListModel = skillSetListModel1;

		skillSetListModel.setObject(getSkillSetList(userIdModel.getObject()));

		Form<?> form = new Form<Void>("form");

		WebMarkupContainer wmc = new WebMarkupContainer("wmc");

		SkillSetListView skillSetList = new SkillSetListView("skillSetList", skillSetListModel, wmc);
	...
	private List<SkillSetDto> getSkillSetList(int userId) {
	    ...
	    for(SkillSetEntity entity: skillsetList) {
		    SkillSetDto skillsetDto = new SkillSetDto();
		    skillsetDto.setSkillSetEntity(entity);
		    skillsetDto.setProcessStartEntity(developmentProcessDao.getProcess(entity.getProcessStart()));
		    skillsetDto.setProcessEndEntity(developmentProcessDao.getProcess(entity.getProcessEnd()));
		    skillsetDto.setSkillSetImageEntityList(skillSetImageDao.getSkillSetImage(entity.getId()));
	...
	class SkillSetListView extends ListView<SkillSetDto> {
		...
		public SkillSetListView(String id, IModel<? extends List<SkillSetDto>> model, WebMarkupContainer wmc) {
			super(id, model);
			this.wmc = wmc;
		}
